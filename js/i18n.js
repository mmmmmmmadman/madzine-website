      ...
      apps: {
        ...
        sessionguide: {
          ...
          features: {
            ...
            cues: '自訂指令格子，即時閃示、小節倒數、漸變三種模式',
            ramp: '漸變指令：橫跨數小節的漸強與漸弱，全螢幕進度顯示',
      ...
      apps: {
        ...
        sessionguide: {
          ...
          features: {
            ...
            cues: 'Custom cue pads: instant flash, bar countdown, or gradual change',
            ramp: 'Gradual cues: crescendo and diminuendo across bars, shown full-screen with progress',
      ...
      apps: {
        ...
        sessionguide: {
          ...
          features: {
            ...
            cues: 'カスタムキューパッド、即時表示・小節カウントダウン・漸次変化の3モード',
            ramp: '漸次変化キュー：複数小節にわたるクレッシェンドとディミヌエンド、全画面で進行状況を表示',
