      ...
      apps: {
        ...
        sessionguide: {
          ...
          features: {
            ...
            cues: '指令由修飾格與動作格組合：立刻、逐漸 N 小節、N 小節後',
      ...
      apps: {
        ...
        sessionguide: {
          ...
          features: {
            ...
            cues: 'Cues combine a modifier pad and an action pad: now, gradually over N bars, or in N bars',
      ...
      apps: {
        ...
        sessionguide: {
          ...
          features: {
            ...
            cues: 'キューは修飾パッドとアクションパッドの組み合わせ：即時・N小節かけて・N小節後',
